...
- **Test without a car** — the [sample app](/obd/emulator) is also an adapter. It hosts an ELM327-compatible OBD-II bus over BLE and TCP, with every PID, trouble code and readiness flag set from a UI — or driven for you by a looping city, highway or commute [scenario](/obd/emulator#driving-scenarios) — so you can develop against a vehicle you control from your desk.
