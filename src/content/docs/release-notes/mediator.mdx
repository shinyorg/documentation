...
# 3.4.0 - TBD
<RN type="feature">ICommandExecuter, IEventExecutor, and IRequestExecutor all added behind mediator to allow more plug points for things like Sentry to watch scope</RN>
...
## Proposals
<RN type="feature">AOT Source Generator for senders</RN>
<RN type="feature">Routing to a transport - SignalR, HTTP, GRPC, RMQ?</RN>
<RN type="enhancement">Event collectors can now trigger an event if a new handler is discovered (ie. User navigates to a page that implements an event handler)</RN>
