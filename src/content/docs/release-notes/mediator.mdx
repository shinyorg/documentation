...
<RN type="enhancement">Shiny.Mediator.AppSupport has a new StoageCacheService that survives app restarts - better for these setups and offline scenarios</RN>
...
## Roadmap
<RN type="enhancement">Include the batteries, but don't install them?</RN>
<RN type="feature">Commands replace Requests and also have their own pipeline</RN>
<RN type="feature">Commands can be scheduled and have time to live</RN>
<RN type="feature">Remote EventGrid/Service Bus - Commands with time to live, scheduled requests, and distributed events</RN>
<RN type="feature">Dashboard showing connected handlers</RN>
<RN type="feature">Streaming AsyncEnumerable Context per pump</RN>
<RN type="enhancement">Keyed storage service for offline & cache - directory does not change though do they still collide</RN>
