...
<RN type="enhancement" breaking={true}>RequestContext, EventContext, CommandContext, and EventAggregatedContext are now all MediatorContext.  MediatorContext has ChildContexts to replace EventAggregatedContext</RN>
