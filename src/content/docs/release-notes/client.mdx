...
# 3.4.0 - January 9, 2025

## Core
<RN type="fix">Target frameworks now enforce net-ios17.0 and net8-android34.0 to allow all levels of the NET8 SDK to continue to reference shiny libraries</RN>
...
## Push
<RN type="fix" breaking={true}>Firebase on iOS won't have a new binding until Shiny 4 and has been removed from distribution for now</RN>
