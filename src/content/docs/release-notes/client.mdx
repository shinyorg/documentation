...
## Core
<RN type="fix" breaking={true}>Target frameworks now enforce net9.0-ios18.0 and net9-android35.0</RN>
...
<RN type="enhancement">HttpTransferRequest.CreateForAzureBlobStorage static helper method</RN>
