...
## HTTP Transfers
* <RN type="enhancement" platform="iOS">Allow fine tuned control of the nsurlsessionconfiguration and the mutable native request on iOS via implementing (& registering) INativeConfigurator</RN><GitHubIssue number={1411} />

## BluetoothLE
* <RN type="fix" platform="Android">IBleDelegate now reports adapter state properly</RN>
* <RN type="fix" platform="Android">BleDelegate does not fire for disconnected event on Android</RN><GitHubIssue number={1397} />
* <RN type="fix" platform="Android">Unsubscribing from a connection may be temporarily unstable if sub/unsub is performed rapidly</RN><GitHubIssue number={1381} />
* <RN type="fix" platform="Android">Reduce logging severity for characteristic events</RN>
* <RN type="fix" platform="iOS">IsScanning flag was not being set</RN><GitHubIssue number={1401} />
* <RN type="fix">Characteristic extension (GetAllCharacteristics) was only returning characteristics from last service</RN><GitHubIssue number={1420} />
...
* <RN type="enhancement" platform="Android">Firebase will not attempt to initialize if it done by other libraries like Firebase Crashlytics</RN><GitHubIssue number={1403} pr={true} contributor="darshanio" />
...
## HTTP Transfers
* <RN type="fix" platform="Android">Ensure HTTP transfer foreground service does start multiple times</RN><GitHubIssue number={1369} pr={true} contributor="berhir" />
...
## Local Notifications
* <RN type="fix" platform="ios">Crash tapping local notification on iOS earlier than 16 when accessing FilterCriteria</RN>GitHubIssue number={1366} />

## Push - Azure Notification Hubs
* <RN type="fix">Ensure latest registered tags are set</RN><GitHubIssue number={1367} pr={true} contributor="thetownfool" />
