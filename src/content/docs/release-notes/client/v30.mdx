...
## HTTP Transfers
<RN type="fix" platform="Android">More aggressive retrying of transfers in queue</Android>
<RN type="fix" platform="Android">Appropriate amount of wizardary applied to remove foreground service notifications</Android>
