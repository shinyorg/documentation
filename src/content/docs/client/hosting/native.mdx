...
:::note
If you already have custom platform boilerplate classes and can't inherit from Shiny's base classes, use the [Manual](/client/hosting/manual) hosting model instead.
:::
