...
See [Platform Setup](/client/wifi/platform/) for what each of those costs in manifest entries and
...
before `GetCurrentNetwork()`. See [Platform Setup](/client/wifi/platform/).
:::
...
Read on: [Networks](/client/wifi/networks/) · [Known Networks](/client/wifi/known-networks/) ·
[Hotspot](/client/wifi/hotspot/) · [Platform Setup](/client/wifi/platform/)
