...
- **You need exact-time scheduling.** Use [Local Notifications](/client/notifications/) with a scheduled trigger to wake the user, not the OS to wake your code.
...
- **You need pub/sub across devices.** Use [Push Notifications](/client/push/) to deliver a wake signal; have the push delegate call `RunJob` if needed.
