...
:::tip
Use the **shiny-http-transfers** skill with [Claude Code](https://claude.ai/code) or [GitHub Copilot](https://docs.github.com/en/copilot) for contextual code generation, background transfer setup, progress monitoring, and best practices.

```bash
claude plugin add github:shinyorg/skills
```

[View Skill](https://github.com/shinyorg/skills/blob/main/skills/shiny-http-transfers/SKILL.md)
:::
