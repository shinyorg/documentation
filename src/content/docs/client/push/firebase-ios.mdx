...
On Android, this package delegates to the built-in Shiny.Push Firebase support. Follow the standard [Push Notifications Getting Started](/client/push/) guide for Android Firebase setup using `google-services.json`.
