...
<RN type="fix" platform="Android">AndroidX version pins for Jobs, Notifications, & Locations</RN>

### 4.0.0 - March 26, 2026

#### Windows Support
- BluetoothLE, BLE Hosting, HTTP Transfers, & Locations all now have support for Windows (No Background Support at this time)
