...
<LibBuilder componentName="screenrecorder" client:load />
...
Same call everywhere. See [Platform Setup](/client/screenrecorder/platform/) for the manifest entries,
...
| Reason | When |
|---|---|
| `RevokedByUser` | Android's cast notification or the recording notification's Stop action, the browser's "Stop sharing" bar, the macOS menu-bar stop |
