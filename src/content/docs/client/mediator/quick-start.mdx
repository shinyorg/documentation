...
<Steps>
1. Install [Shiny.Mediator](https://www.nuget.org/packages/Shiny.Mediator) from NuGet
...
<Steps>
1. Install [Shiny.Mediator.Maui](https://www.nuget.org/packages/Shiny.Mediator.Maui)
