...
* Contains simple POCOs (plain old C# classes) or records that implements (logic does not belong here)
    ...
    * Shiny.Mediator.IRequest<Response>
...
* Create Any
    * Request Handlers (Shiny.Mediator.IRequestHandler or Shiny.Mediator.IRequestHandler<Response>)
    * Event Handlers (Shiny.Mediator.IEventHandler<Event>)
