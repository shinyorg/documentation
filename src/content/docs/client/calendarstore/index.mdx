...
See [Permissions](/client/calendarstore/permissions) for the per-platform manifest keys.
...
- [Permissions](/client/calendarstore/permissions)
- [Querying](/client/calendarstore/querying)
- [AI Tools](/client/calendarstore/ai-tools)
