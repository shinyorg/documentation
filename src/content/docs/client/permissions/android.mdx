...
When the [MAUI permission presets](/client/permissions/) aren't enough, you can declare Android-specific manifest permissions and hardware features directly.
