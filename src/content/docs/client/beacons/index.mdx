...
Each takes an optional [`BeaconRangingOptions`](/client/beacons/distance). `AddBeaconMonitoring` also wires
...
- [Ranging](/client/beacons/ranging) — foreground detection and distance
- [Monitoring](/client/beacons/monitoring) — background enter/exit regions
- [Eddystone](/client/beacons/eddystone) — UID, URL and telemetry frames
- [Broadcasting](/client/beacons/broadcasting) — becoming a beacon
- [Distance & Accuracy](/client/beacons/distance) — filtering, estimators, and tuning
