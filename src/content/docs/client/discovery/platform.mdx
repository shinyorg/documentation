...
|----------|---------|-------------|
| iOS / tvOS / Mac Catalyst / macOS | `NSNetService` (Bonjour) | Goes through the system `mDNSResponder` daemon — **no multicast entitlement required** |
...
|----------|------|---------------------|
| iOS / tvOS | `NSBonjourServices` + usage description | **`com.apple.developer.networking.multicast`** (Apple approval required) + usage description |
