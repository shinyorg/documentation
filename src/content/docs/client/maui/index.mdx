...
- [Navigation](/client/maui/navigation) — Full `INavigator` API reference
- [ViewModel Lifecycle](/client/maui/lifecycle) — Lifecycle interfaces and events
- [Source Generation](/client/maui/sourcegen) — Eliminate boilerplate with attributes
