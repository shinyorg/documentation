...
internal static class __ShinyMauiNavigationRegistry
{
    ...
    public static void Initialize()
    {
        ...
        {
            builder.Add<global::Sample.AnotherPage, global::Sample.AnotherViewModel>(Routes.Another);
            builder.Add<global::Sample.MainPage, global::Sample.MainViewModel>(Routes.Main, registerRoute: false);
            builder.Add<global::Sample.ModalPage, global::Sample.ModalViewModel>(Routes.Modal);
        });
    }
}
