...
| Idle | Dragging over the window | After the drop |
|:---:|:---:|:---:|
| <img src="/images/file-drop/blazor-s1.png" width="640" alt="The status panel before anything is dragged over the window" /> | <img src="/images/file-drop/blazor-s2.png" width="640" alt="The whole window outlined and tinted, reading Drop to accept 2 file(s)" /> | <img src="/images/file-drop/blazor-s3.png" width="640" alt="The dropped files listed with an event log entry beneath them" /> |

:::note[No screenshots on iOS or Android]
Window-level file drop needs a desktop window manager, so the MAUI demo page shows an unsupported
notice on a phone. The MAUI shots have to come from a Windows, macOS or GTK4 head.
:::
