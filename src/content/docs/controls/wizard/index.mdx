...
|:---:|:---:|:---:|
| <img src="/images/wizard/s1.png" width="220" alt="Step one with Next disabled until the email is plausible" /> | <img src="/images/wizard/s2.png" width="220" alt="The same step with a valid email and Next enabled" /> | <img src="/images/wizard/s3.png" width="220" alt="The Fulfilment step with the chevron indicator advanced" /> |

**Blazor**

| Next gated by validation | Valid — Next enabled | The next step | Indicator styles |
|:---:|:---:|:---:|:---:|
| <img src="/images/wizard/blazor-s1.png" width="220" alt="Step one with Next disabled on Blazor" /> | <img src="/images/wizard/blazor-s2.png" width="220" alt="A valid email enabling Next on Blazor" /> | <img src="/images/wizard/blazor-s3.png" width="220" alt="The Fulfilment step on Blazor" /> | <img src="/images/wizard/blazor-s4.png" width="220" alt="The dots progress indicator" /> |
