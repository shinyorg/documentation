...
<img src="/images/pillview/blazor-s1.png" width="220" alt="Types, colours and sizes on Blazor" />
...
:::note
On Blazor, colors are CSS strings. The same preset types and auto-contrast behavior apply. Style overrides use Blazor CSS isolation instead of MAUI `ResourceDictionary`.
:::
