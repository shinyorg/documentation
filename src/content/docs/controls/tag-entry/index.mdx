...
| Committed tags | Limits, templates, read-only |
|:---:|:---:|
| <img src="/images/tag-entry/s1.png" width="220" alt="Email tags committed with comma and semicolon on .NET MAUI" /> | <img src="/images/tag-entry/s2.png" width="220" alt="Capped, duplicate, templated, read-only and disabled tag entries on .NET MAUI" /> |

**Blazor**

| Default | Validation | Chip content |
|:---:|:---:|:---:|
| <img src="/images/tag-entry/blazor-s1.png" width="280" alt="Two committed tags and a placeholder in the typing area on Blazor" /> | <img src="/images/tag-entry/blazor-s2.png" width="280" alt="A tag refused by validation with its reason on Blazor" /> | <img src="/images/tag-entry/blazor-s3.png" width="280" alt="Chips with custom content on Blazor" /> |
