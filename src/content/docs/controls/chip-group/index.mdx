...
| Single, multiple, capped | Templated and removable |
|:---:|:---:|
| <img src="/images/chip-group/s1.png" width="220" alt="Selected chips with check marks in single, multiple and capped groups on .NET MAUI" /> | <img src="/images/chip-group/s2.png" width="220" alt="Chips with count badges, removable chips and a non-wrapping row on .NET MAUI" /> |

**Blazor**

| Multiple selection | Removable | Colours |
|:---:|:---:|:---:|
| <img src="/images/chip-group/blazor-s1.png" width="280" alt="Filter chips with several selected on Blazor" /> | <img src="/images/chip-group/blazor-s2.png" width="280" alt="Removable chips each with a close button on Blazor" /> | <img src="/images/chip-group/blazor-s3.png" width="280" alt="Chips in the theme's colour roles on Blazor" /> |
