...
<img src="/images/datagrid/s4.png" width="220" alt="An expanded row showing a breakdown panel under Ada on .NET MAUI" /> <img src="/images/datagrid/blazor-s4.png" width="420" alt="An expanded breakdown row on Blazor" />
