...
<img src="/images/datagrid/s2.png" width="220" alt="First and Status columns pinned while the middle columns scroll under them on .NET MAUI" /> <img src="/images/datagrid/blazor-s2.png" width="420" alt="First and last columns pinned with a sticky header on Blazor" />
