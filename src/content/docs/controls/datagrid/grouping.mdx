...
<img src="/images/datagrid/s3.png" width="220" alt="Rows grouped by region with per-group totals, one group expanded, on .NET MAUI" /> <img src="/images/datagrid/blazor-s3.png" width="420" alt="Rows grouped by department with Total and Average summary rows on Blazor" />
