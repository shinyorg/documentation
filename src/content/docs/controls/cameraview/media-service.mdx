...
:::note[Blazor]
Blazor has its own `IMediaService` with the same verbs and options, minus what a browser cannot do. See
[IMediaService on Blazor](/controls/cameraview/media-service-blazor).
:::
