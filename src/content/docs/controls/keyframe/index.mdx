...
|:---:|:---:|
| <img src="/images/keyframe/s1.png" width="220" alt="Pulse, slide-in, spring and stepped animations running on real MAUI views" /> | <img src="/images/keyframe/s2.png" width="220" alt="The same timeline model rendered to a canvas, with a scrubber and play/pause/reverse" /> |
