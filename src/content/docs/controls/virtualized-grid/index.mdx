...
|:---:|:---:|:---:|:---:|
| <img src="/images/virtualized-grid/s1-flat.png" width="180" alt="Flat virtualized grid with 240 items and adjustable column count" /> | <img src="/images/virtualized-grid/s2-grouped.png" width="180" alt="Grouped virtualized grid with sticky headers" /> | <img src="/images/virtualized-grid/s3-loadmore-modes.png" width="180" alt="Load-more mode toggle between button and threshold" /> | <img src="/images/virtualized-grid/s4-loadmore-button.png" width="180" alt="Load More button rendered at the end of the grid" /> |

**Blazor**

| Flat grid | Grouped with sticky headers | Header, footer and load more |
|:---:|:---:|:---:|
| <img src="/images/virtualized-grid/blazor-s1.png" width="420" alt="Flat grid on Blazor" /> | <img src="/images/virtualized-grid/blazor-s2.png" width="420" alt="Grouped with sticky headers on Blazor" /> | <img src="/images/virtualized-grid/blazor-s3.png" width="420" alt="Header, footer and load more on Blazor" /> |
