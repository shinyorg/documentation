...
- **`Shiny.Blazor.Controls`** — Blazor (browser, Blazor Server, `BlazorWebView`). No add-on package: it would ship in the main controls package alongside [Docking](/controls/docking/). Namespace: `Shiny.Blazor.Controls.OnScreenKeyboard`.
