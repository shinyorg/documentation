...
- **`Shiny.Blazor.Controls.Kiosk`** — Blazor (browser, Blazor Server, `BlazorWebView`). Bundled with [Docking](/controls/docking/) under the kiosk-shaped add-on. Namespace: `Shiny.Blazor.Controls.Kiosk.OnScreenKeyboard`.
