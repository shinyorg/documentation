...
<img src="/images/media-picker-button/blazor-s1.png" width="220" alt="MediaPickerButton on Blazor" /> <img src="/images/media-picker-button/blazor-s2.png" width="360" alt="Two picked photos with remove buttons above Add Photo on Blazor" />
...
| `AllowCamera` | bool | `true` | Offer "take photo". When both are enabled, tapping shows a gallery/camera chooser — except in Blazor on iPhone/iPad, where the browser's own Photo Library / Take Photo / Choose File sheet is shown instead |
