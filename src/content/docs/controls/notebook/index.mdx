...
| `NotebookEditorView` — ribbon, section tabs, page list | A page of shapes and ink | The Draw tab |
|:---:|:---:|:---:|
...
| `NotebookEditorView` | The Draw tab on a sketch page | `NotebookEditor` — the bare canvas |
|:---:|:---:|:---:|
