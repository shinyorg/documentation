...
| <img src="/images/scheduler/s4.png" width="200" alt="Agenda with Calendar Picker" /> | | |

**Blazor**

| Calendar view | Agenda view | Event list |
|:---:|:---:|:---:|
| <img src="/images/scheduler/blazor-s1.png" width="220" alt="Calendar view on Blazor" /> | <img src="/images/scheduler/blazor-s2.png" width="220" alt="Agenda view on Blazor" /> | <img src="/images/scheduler/blazor-s3.png" width="220" alt="Event list on Blazor" /> |
...
- [Calendar View](/controls/scheduler/calendar) — Monthly calendar grid with event indicators
- [Agenda View](/controls/scheduler/agenda) — Day/multi-day timeline with overlap detection
- [Drag & Drop Editing](/controls/scheduler/drag-drop) — Move and resize agenda events by dragging
- [Event List](/controls/scheduler/event-list) — Vertically scrolling event list grouped by day
- [Custom Templates](/controls/scheduler/templates) — Override any visual element with custom DataTemplates
- [Release Notes](/controls/scheduler/release-notes)
