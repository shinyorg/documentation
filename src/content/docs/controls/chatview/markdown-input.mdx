...
The input bar itself is a standalone control (`ChatEntryView` / `ChatEntry`) that ChatView hosts for you — see [The Composer](./composer) for its own properties, how to replace it, and how to use it outside a chat.
