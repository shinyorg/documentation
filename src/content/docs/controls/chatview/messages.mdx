...
:::note
On MAUI, `ChatMessage` does not implement `INotifyPropertyChanged`. To refresh the UI after changing `DateSent`, remove and re-insert the message in the collection:
```csharp
