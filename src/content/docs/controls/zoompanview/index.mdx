...
| Blazor — every gesture on its own switch |
|:---:|
| <img src="/images/zoompanview/blazor-s1.png" width="420" alt="Per-gesture toggles for pinch, pan, wheel and double-tap on Blazor" /> |
