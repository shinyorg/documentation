...
`SheetView` has been replaced by `FloatingPanel` + `OverlayHost` on MAUI. The Blazor package still ships `SheetView` as a Razor component — see [Sheet View (Blazor Only)](/controls/sheetview/).
:::
