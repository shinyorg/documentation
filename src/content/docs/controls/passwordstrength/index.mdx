...
| A strong passphrase | Weak, and a blocked word |
|:---:|:---:|
| <img src="/images/passwordstrength/s1.png" width="220" alt="Four filled segments reading Strong with both requirements met" /> | <img src="/images/passwordstrength/s2.png" width="220" alt="A common password and a blocked house word, each refused with a reason" /> |

**Blazor**

| Defaults, passphrase-first | Legacy composition policy | Blocked words |
|:---:|:---:|:---:|
| <img src="/images/passwordstrength/blazor-s1.png" width="560" alt="A long passphrase scoring Strong on Blazor" /> | <img src="/images/passwordstrength/blazor-s2.png" width="560" alt="A single bar with a per-rule checklist and a common-password warning" /> | <img src="/images/passwordstrength/blazor-s3.png" width="560" alt="A house-list word refused with This password is not allowed" /> |

| Localized wording |
|:---:|
| <img src="/images/passwordstrength/blazor-s4.png" width="560" alt="French labels, rules and a Bon rating on Blazor" /> |
...
| MAUI | Blazor |
|:---:|:---:|
| <img src="/images/passwordstrength/s3.png" width="220" alt="The meter and rule list in French on .NET MAUI" /> | <img src="/images/passwordstrength/blazor-s4.png" width="480" alt="French labels, rules and a Bon rating on Blazor" /> |
...
control.Localizer = text => text.Key switch
{
    ...
    // Value carries the matched word or personal detail
...
That includes the built-in evaluator's **warning**. It tags each one with `PasswordStrengthResult.WarningKey` — `WarningCompromised`, `WarningBlocked`, `WarningUserInput` or `WarningCommonPassword` — and `WarningValue`, the matched word or detail, which reaches the localizer as `PasswordStrengthText.Value`. A custom evaluator's warning that carries no key is shown exactly as written.
