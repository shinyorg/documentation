...
| MAUI — empty | Blazor — with selection |
|:---:|:---:|
| <img src="/images/countrypicker/s1.png" width="220" alt="CountryPicker on MAUI with no country selected" /> | <img src="/images/countrypicker/blazor-s1.png" width="220" alt="CountryPicker on Blazor with a country selected" /> |
