...
{/* TODO: MAUI screenshot of the *docked* line is still outstanding — a page-docked ProgressLine never enters the visual tree on iOS, and the service-driven line paints across the page content instead of the top edge. Only the inline (Dock="False") shot is real. */}
