...
| Bound to a value | Driven from the service | Anchored to a container |
|:---:|:---:|:---:|
| <img src="/images/progressline/blazor-s1.png" width="640" alt="The line pinned to the top of the window following a slider" /> | <img src="/images/progressline/blazor-s2.png" width="640" alt="A reported-percentage run painting across the top edge" /> | <img src="/images/progressline/blazor-s3.png" width="640" alt="The line running along the edge of a panel instead of the window" /> |

**MAUI** (iOS)

| Dock="False", inline |
|:---:|
| <img src="/images/progressline/s1.png" width="220" alt="The gradient line rendered where it is declared rather than docked" /> |

| Docked line | Service, top edge | Service, bottom edge |
|:---:|:---:|:---:|
| <img src="/images/progressline/s2.png" width="220" alt="The orange page-docked line at 40% under the navigation bar on .NET MAUI" /> | <img src="/images/progressline/s4.png" width="220" alt="A service-driven line at 80% under the navigation bar on .NET MAUI" /> | <img src="/images/progressline/s3.png" width="220" alt="A service-driven gradient line along the bottom edge on .NET MAUI" /> |
