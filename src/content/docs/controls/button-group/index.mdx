...
| Actions and selection | Split, text, vertical, nested |
|:---:|:---:|
| <img src="/images/button-group/s1.png" width="220" alt="An action group, a Day/Week/Month picker and a B/I/U multi-select on .NET MAUI" /> | <img src="/images/button-group/s2.png" width="220" alt="A split button, a USD stepper, a vertical zoom rail and nested groups on .NET MAUI" /> |

**Blazor**

| Actions | Single selection | Split button |
|:---:|:---:|:---:|
| <img src="/images/button-group/blazor-s1.png" width="280" alt="A row of joined action buttons on Blazor" /> | <img src="/images/button-group/blazor-s2.png" width="280" alt="Day, Week and Month as a segmented picker with Week selected on Blazor" /> | <img src="/images/button-group/blazor-s3.png" width="280" alt="A split button with a separator between the action and its menu on Blazor" /> |
