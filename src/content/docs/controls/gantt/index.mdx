...
|:---:|:---:|
| <img src="/images/gantt/s1.png" width="220" alt="A Gantt plan with the critical path highlighted on .NET MAUI" /> | <img src="/images/gantt/s2.png" width="220" alt="The same plan with the critical path off on .NET MAUI" /> |

**Blazor**

| Critical path | Plain plan |
|:---:|:---:|
| <img src="/images/gantt/blazor-s1.png" width="420" alt="A Gantt plan with the critical path highlighted on Blazor" /> | <img src="/images/gantt/blazor-s2.png" width="420" alt="The same plan with the critical path off on Blazor" /> |

| Baselines | Week scale |
|:---:|:---:|
| <img src="/images/gantt/blazor-s3.png" width="420" alt="Baseline bars drawn under the planned bars on Blazor" /> | <img src="/images/gantt/blazor-s4.png" width="420" alt="The whole plan zoomed out to a week-per-column scale on Blazor" /> |
