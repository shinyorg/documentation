...
|----|-----------|-----|
|DotLiquid|DotLiquid template parsing|<NugetBadge name="Shiny.Extensions.Mail.DotLiquid" />|
|Storage.NET|Loads templates from FTP, filesystem, Azure Blobs, etc - read more about Storage.NET here: [GitHub](https://github.com/aloneguid/storage)|<NugetBadge name="Shiny.Extensions.Mail.StorageNet" />|
