...
Shiny.NET is a collection of libraries designed to make .NET development faster, cleaner, and more productive — whether you're building mobile apps, APIs, or anything in between.
...
Catch [Allan Ritchie](https://github.com/aritchie) (author of Shiny) & [Jon Dick (Redth)](https://github.com/redth) every week on the **Gone .NET** YouTube channel for .NET deep dives, library walkthroughs, and community discussions.

<a href="https://youtube.com/@GoneDotNet">
    <Image src={goneMobileImg} width="300" alt="Gone .NET YouTube Channel" />
</a>
...
<Image src={allanImg} width="150" alt="Allan Ritchie" style="border-radius: 50%;" />
<div>

Shiny.NET is built and maintained by [Allan Ritchie](https://allanritchie.com), a software engineer with 25+ years of experience specializing in .NET architecture across cloud, mobile, desktop, and web. Allan is an [8x Microsoft MVP](https://mvp.microsoft.com/en-us/PublicProfile/5002565) and has been building cross-platform .NET libraries since the early Xamarin days. His open-source packages have been downloaded over 40 million times on NuGet.

Need help integrating Shiny into your application or want consulting support? Reach out at [allan@shinysoft.biz](mailto:allan@shinysoft.biz).
