...
On iOS, your delegate has approximately 4 seconds of execution time (including DI initialization). Keep your processing fast or offload heavy work to a [Job](/jobs).
:::
