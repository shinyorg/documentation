...
| SQLite | <NugetBadge name="Shiny.DocumentDb.Sqlite" showLabel={true} /> |
| SQLCipher | <NugetBadge name="Shiny.DocumentDb.Sqlite.SqlCipher" showLabel={true} /> |
| SQL Server | <NugetBadge name="Shiny.DocumentDb.SqlServer" showLabel={true} /> |
| MySQL | <NugetBadge name="Shiny.DocumentDb.MySql" showLabel={true} /> |
| PostgreSQL | <NugetBadge name="Shiny.DocumentDb.PostgreSql" showLabel={true} /> |
| DI Extensions | <NugetBadge name="Shiny.DocumentDb.Extensions.DependencyInjection" showLabel={true} /> |
| AI Tools | <NugetBadge name="Shiny.DocumentDb.Extensions.AI" showLabel={true} /> |
