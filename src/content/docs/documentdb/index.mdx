...
| SQLite vector support (`sqlite-vec`) | <NugetDownloads name="Shiny.DocumentDb.Sqlite.VectorSupport" /> |
| SQLCipher (encrypted SQLite) | <NugetDownloads name="Shiny.DocumentDb.Sqlite.SqlCipher" /> |
| PostgreSQL | <NugetDownloads name="Shiny.DocumentDb.PostgreSql" /> |
| CockroachDB | <NugetDownloads name="Shiny.DocumentDb.CockroachDb" /> |
| SQL Server | <NugetDownloads name="Shiny.DocumentDb.SqlServer" /> |
| MySQL | <NugetDownloads name="Shiny.DocumentDb.MySql" /> |
| MariaDB | <NugetDownloads name="Shiny.DocumentDb.MariaDb" /> |
| Oracle | <NugetDownloads name="Shiny.DocumentDb.Oracle" /> |
| DuckDB | <NugetDownloads name="Shiny.DocumentDb.DuckDb" /> |
| Azure Cosmos DB | <NugetDownloads name="Shiny.DocumentDb.CosmosDb" /> |
| Azure Table Storage | <NugetDownloads name="Shiny.DocumentDb.AzureTable" /> |
| Amazon DynamoDB | <NugetDownloads name="Shiny.DocumentDb.DynamoDb" /> |
| MongoDB | <NugetDownloads name="Shiny.DocumentDb.MongoDb" /> |
| Amazon DocumentDB | <NugetDownloads name="Shiny.DocumentDb.DocumentDb" /> |
| Redis | <NugetDownloads name="Shiny.DocumentDb.Redis" /> |
| RavenDB | <NugetDownloads name="Shiny.DocumentDb.RavenDb" /> |
| Google Firestore | <NugetDownloads name="Shiny.DocumentDb.Firestore" /> |
| LiteDB | <NugetDownloads name="Shiny.DocumentDb.LiteDb" /> |
| IndexedDB (Blazor WASM) | <NugetDownloads name="Shiny.DocumentDb.IndexedDb" /> |
