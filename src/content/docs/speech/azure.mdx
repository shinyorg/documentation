...
:::caution
Cloud providers still require `AddAudioSource()` and `AddAudioPlayer()` for microphone capture and speaker playback. Azure provides the recognition/synthesis engine, but audio I/O is handled by the platform.
:::
