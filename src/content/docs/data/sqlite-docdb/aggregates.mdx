...
```
:::note
The table name `documents` is the default. When using [table-per-type mapping](/data/sqlite-docdb/#table-per-type-mapping), aggregates target the mapped table automatically.
:::
