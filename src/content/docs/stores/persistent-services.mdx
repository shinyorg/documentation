...
:::tip
Mark your persistent service class with `[Reflector]` from [Shiny Reflector](/reflector/) and make it `partial`. This eliminates runtime reflection for property binding, making it AOT-compatible and faster. Reflector is already built into the Stores package.
:::
