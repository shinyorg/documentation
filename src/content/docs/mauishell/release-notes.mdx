...
Implementers of `INavigator` or `INavigationBuilder` (test doubles, mostly) update their return types
...
`INavigationConfirmation`, `INavigationAware`, `IPageLifecycleAware`, `[ShellMap]`, `[ShellProperty]`
