...
Zero-friction integration between [.NET Aspire](https://learn.microsoft.com/dotnet/aspire/) and [Microsoft Orleans](https://learn.microsoft.com/dotnet/aspire/orleans/) for ADO.NET storage backends. Automatically provisions Orleans database schemas and wires up clustering, grain persistence, and reminders from Aspire configuration — no manual SQL scripts or connection string plumbing required.

| | |
|---------|---------|
| GitHub | <GitHubStars org="shinyorg" repo="aspire" /> |
| Downloads | <NugetDownloads name="Shiny.Aspire.Orleans.Hosting" /> |
| Aspire AppHost | <NugetDownloads name="Shiny.Aspire.Orleans.Hosting" /> |
| Orleans Silo | <NugetDownloads name="Shiny.Aspire.Orleans.Server" /> |
| Orleans Client | <NugetDownloads name="Shiny.Aspire.Orleans.Client" /> |
