...
<ul class="list-disc">
    <li>MediatorSingletonAttribute</li>
    <li>MediatorScopedAttribute</li>
</ul>
...
Please read [Source Generation (AOT)](/mediator/sourcegeneration) for more information

## AI Coding Assistant

An AI skill is available for Shiny Mediator to help generate handlers, contracts, middleware, and scaffold projects directly in your IDE.
...
**GitHub Copilot** — Copy the [shiny-mediator](https://github.com/shinyorg/skills/blob/main/skills/shiny-mediator/SKILL.md) skill file into your repository's [custom instructions](https://docs.github.com/en/copilot/customizing-copilot/adding-repository-custom-instructions).