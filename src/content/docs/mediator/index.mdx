...
| | |
|---------|---------|
| GitHub | <GitHubStars org="shinyorg" repo="mediator" /> |
| Core | <NugetDownloads name="Shiny.Mediator" /> |
| MAUI | <NugetDownloads name="Shiny.Mediator.Maui" /> |
| Blazor | <NugetDownloads name="Shiny.Mediator.Blazor" /> |
| ASP.NET | <NugetDownloads name="Shiny.Mediator.AspNet" /> |
| Prism | <NugetDownloads name="Shiny.Mediator.Prism" /> |
| Uno Platform | <NugetDownloads name="Shiny.Mediator.Uno" /> |
| Dapper | <NugetDownloads name="Shiny.Mediator.DapperRequests" /> |
| Resilience | <NugetDownloads name="Shiny.Mediator.Resilience" /> |
| FluentValidation | <NugetDownloads name="Shiny.Mediator.FluentValidation" /> |
| Caching | <NugetDownloads name="Shiny.Mediator.Caching.MicrosoftMemoryCache" /> |
...
- **[AI Tools](/mediator/extensions/ai)** — Expose contracts as AI-callable tools via Microsoft.Extensions.AI
...
- **[Validation](/mediator/middleware/validation)** — Contract validation via FluentValidation
...
- **[Event Throttle](/mediator/middleware/throttle)** — Discard rapid duplicate events within a cooldown window
