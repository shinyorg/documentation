...
- Our [MAUI](./extensions/maui) & [Blazor](./extensions/blazor) integrations allow your viewmodels or pages to implement an IEventHandler interface(s) without them having to participate in the dependency injection provider
...
- Easy to Unit Test
- [OpenAPI Contract](./extensions/http) Generator that can save you all the boilerplate and still allow you to apply middleware
- [Epic Out-of-the-Box Middleware](./middleware/)
    ...
    - [Replayable Streams](./middleware/replayablestreams)
