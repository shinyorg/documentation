...
3. Now to wire up our handler with DI
    ...
    services.AddSingleton<IStreamRequestHandler<MyStreamRequest, string>, MyStreamHandler>();
    services.AddScoped<IStreamRequestHandler<MyStreamRequest, string>, MyStreamHandler>();
    ...
    services.AddScopedAsImplementedInterfaces<MyStreamHandler>();
