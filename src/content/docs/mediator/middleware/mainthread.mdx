...
Your handler class must be marked as partial for source generation to work correctly on the MainThreadAttribute.
:::
...
```csharp
public partial class MyViewModel : BaseViewModel, IEventHandler<MyEvent>, IEventHandler<MyOtherEvent>
{
    [MainThread]
