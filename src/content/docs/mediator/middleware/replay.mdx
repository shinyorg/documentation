...
:::note
Refresh timer middleware is applied only to [Streams](../streams)
:::
...
{
    public async IAsyncEnumerable<string> Handle(MyRequest request, MediatorContext context, [EnumeratorCancellation] CancellationToken cancellationToken)
    {
        ... some long http call
    }
} 
