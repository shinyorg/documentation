...
```csharp
public partial class MyRequestHandler : IRequestHandler<MyRequest, IReadOnlyList<MyThingData>>
{
    [OfflineAvailable]
...
:::caution
Offline stores data using JSON serialization (out of the box).  If AOT & Trimming is something you want in your app.  You need to either:
