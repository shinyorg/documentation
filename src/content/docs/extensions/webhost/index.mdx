...
<PlatformSupport frameworks={["aspnet"]} />
...
**GitHub Copilot** — Copy the [shiny-web-hosting](https://github.com/shinyorg/skills/blob/main/skills/shiny-web-hosting/SKILL.md) skill file into your repository's [custom instructions](https://docs.github.com/en/copilot/customizing-copilot/adding-repository-custom-instructions).
