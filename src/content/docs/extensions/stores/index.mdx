...
**GitHub Copilot** — Copy the [shiny-stores](https://github.com/shinyorg/skills/blob/main/skills/shiny-stores/SKILL.md) skill file into your repository's [custom instructions](https://docs.github.com/en/copilot/customizing-copilot/adding-repository-custom-instructions).
