...
- <GitHubStars org="shinyorg" repo="scheduler" />
- <NugetBadge name="Shiny.Maui.Scheduler" showLabel={true} />
...
**GitHub Copilot** — Copy the [shiny-maui-scheduler](https://github.com/shinyorg/skills/blob/main/skills/shiny-maui-scheduler/SKILL.md) skill file into your repository's [custom instructions](https://docs.github.com/en/copilot/customizing-copilot/adding-repository-custom-instructions).
