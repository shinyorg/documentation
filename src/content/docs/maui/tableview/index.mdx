...
An AI skill is available for Shiny TableView to help generate pages, cell configurations, and styling directly in your IDE.
...
**GitHub Copilot** — Copy the [shiny-tableview](https://github.com/shinyorg/skills/blob/main/skills/shiny-tableview/SKILL.md) skill file into your repository's [custom instructions](https://docs.github.com/en/copilot/customizing-copilot/adding-repository-custom-instructions).
