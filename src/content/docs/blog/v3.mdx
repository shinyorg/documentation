...
We have a ton of modules that we haven't released to the wild and are considering bringing out piece by piece.  Shiny is platform designed to be a plugin base
for .NET platforms.
