...
Full details on each: [Contacts AI Tools](/client/contactstore/ai-tools), [Reminder AI Tools](/client/notifications/ai-tools), and [Location AI Tools](/client/locations/ai-tools). Same pattern as [Health AI Tools](/health/ai-tools) — opt-in, read-only by default, AOT-safe, and now your agent has hands.
