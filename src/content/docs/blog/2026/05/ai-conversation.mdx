...
We ship two sample apps that prove it: a full [MAUI sample](https://github.com/shinyorg/speech/tree/main/samples/MauiSample) with chat, settings, and an animated aura visualization, plus a [Blazor sample](https://github.com/shinyorg/speech/tree/main/samples/BlazorSample) with the same features translated to Razor components and CSS animations.
...
- [MAUI Sample](https://github.com/shinyorg/speech/tree/main/samples/MauiSample)
- [Blazor Sample](https://github.com/shinyorg/speech/tree/main/samples/BlazorSample)
