...
The [HTTP Transfers docs](/client/httptransfers/) cover the delegate and retry model, [monitoring](/client/httptransfers/monitoring/),
[progress surfaces](/client/httptransfers/progress/), and the [Azure](/client/httptransfers/azure/) and
[S3](/client/httptransfers/aws-s3/) builders.
