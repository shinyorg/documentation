...
GPS-driven geofence monitoring for iOS and Android. Built on [Shiny.Locations](/locations/gps) for background GPS and [Shiny.Spatial](/spatial/) for spatial queries.
...
:::tip
Spatial geofencing is ideal when you need to monitor many complex polygon regions (cities, states, provinces, custom boundaries). For a small number of simple circular geofences, [platform geofencing](/locations/geofencing) is more battery efficient.
:::
