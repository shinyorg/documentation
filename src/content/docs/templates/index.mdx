...
Three project templates, three item templates, and a [browser-based builder](/foundation/appbuilder/) that produces the same output as `dotnet new` — without installing the SDK pack.
...
Works with Visual Studio 2022 (Windows & Mac), JetBrains Rider 2024+, and the .NET CLI on macOS, Linux, and Windows. For interactive option pickers without installing the pack, use the [App Builder](/foundation/appbuilder/).
