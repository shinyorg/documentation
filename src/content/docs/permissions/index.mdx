...
| | |
|---------|---------|
| GitHub | <GitHubStars org="shinyorg" repo="msbuildpermissions" /> |
| Downloads | <NugetDownloads name="Shiny.Permissions.MSBuild" /> |
...
- [Android](/permissions/android) — Granular manifest permissions and hardware features
- [iOS](/permissions/ios) — Info.plist entries with typed values and arrays
