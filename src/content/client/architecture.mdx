...
<Expander header="Why does Shiny use delegates instead of .NET based events?">
...
<Expander header="Why does Shiny have it's own platform lifecycles - why not just use what's built into MAUI?">
...
<Expander header="Why does Shiny uses Reactive Extensions?">
