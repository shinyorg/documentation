...
Generally speaking NO. Treat UUIDs as a "per scan" basis.  The UUID is not guaranteed to be the same across app restarts.  The counterpoint to this 
is YES - if your device is paired.  It is usually better to use manufacturer data or advertised service UUIDs to identify your peripheral(s).
</Expander>
