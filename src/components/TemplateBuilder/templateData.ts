...
export const VERSIONS = {
    ...
    shinyMediator: '6.4.0',
    shinyShell: '6.1.1',
    shinyControls: '1.0.1-beta-0087',
    // Shiny — client packages that share the core release train
    shinyClient: '5.0.0-beta-0113',
    shinyConfiguration: '5.0.0-beta-0113',
    shinyLocalization: '2.0.1',
    shinyStores: '4.1.0',
    shinyReflector: '4.1.0',
    shinyDI: '4.1.0',
    shinySpatial: '1.1.0',
    ...
    shinyMauiHosting: '4.1.0',
    shinyWebHosting: '4.1.0',
